        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="text-center animate-fade-in-left">
              <div className="w-16 h-16 mx-auto mb-6 rounded-full flex items-center justify-center animate-subtle-pulse" style={{ backgroundColor: '#ba0d2f' }}>
              ...
              <a 
                ...
                className="text-2xl font-bold underline transition-colors duration-300 hover:scale-105 transform"
                style={{ color: '#ba0d2f' }}
              >
                614-247-5703
              </a>
